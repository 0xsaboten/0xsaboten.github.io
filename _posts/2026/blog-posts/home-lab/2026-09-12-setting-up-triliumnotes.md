---
title: Setting up a Trilium Notes Sync Server
description: Syncing notes across multiple devices with Trilium.
date: 2026-09-12 11:37:56
categories: [Blog, Home Lab]
tags: [home lab, proxmox, trilium]
pin: false
image:
  path: /assets/img/2026-posts/home-lab/trilium-mac-client.png
  alt: Trilium Notes
---
...
![Proxmox Container](/assets/img/2026-posts/home-lab/proxmox-create.png)

I'm going to be configuring my Trilium Sync Server with the following specs:

![Proxmox Config](/assets/img/2026-posts/home-lab/proxmox-create-ct.png)
...
![Proxmox CT](/assets/img/2026-posts/home-lab/proxmox-ct-confirm.png)

## Setting up Trilium

After clicking on `Finish`, I can see my new container, `102 (trilium)`. I start the server up with the `Start` button in the top right and then click on `Console` to get a shell on the box.

![Proxmox Trilium](/assets/img/2026-posts/home-lab/proxmox-trilium.png)
...
![Trilium Server](/assets/img/2026-posts/home-lab/trilium-server.png)
...
![Trilium Pass](/assets/img/2026-posts/home-lab/trilium-web.png)
...
![Trilium Mac Setup](/assets/img/2026-posts/home-lab/trilium-mac-setup.png)
...
![Trilium Mac](/assets/img/2026-posts/home-lab/trilium-mac-client.png)
...
![Trilium Mac Test](/assets/img/2026-posts/home-lab/trilium-mac-test.png)

And after about a minute or two

![Trilium Kali Test](/assets/img/2026-posts/home-lab/trilium-kali-test.png)
